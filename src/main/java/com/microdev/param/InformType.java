...
public enum InformType {
    ...
    hotel_bind_hr_fail("酒店绑定人力公司"),hr_bind_hotel_fail("人力公司绑定酒店"),hr_allocation_success("人力申请调配"),hr_allocation_fail("人力申请调配"),worker_apply_cancel_fail("小时工申请取消任务"),hotel_agree_apply("酒店同意任务拒绝");
