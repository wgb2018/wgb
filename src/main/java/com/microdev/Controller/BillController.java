...
public class BillController {
     ...
     *
     */
    @PostMapping("/hotel/bill/{HotelId}")
     ...
     *
     */
    @PostMapping("/hrCompany/bill/{HrCompanylId}/hotel")
     ...
     *
     */
    @PostMapping("/hrCompany/bill/{HrCompanylId}/worker")
     ...
     *
     */
    @PostMapping("/worker/bill/{workerId}")
